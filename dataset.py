...
if __name__=='__main__':
    ...
    size = ''
    batch = ''
    dataloader_sketch, sampler_sketch = create_dataloader(dataroot_sketch, size, batch)
    dataloader_image, sampler_image = create_dataloader(dataroot_image, size, batch)
